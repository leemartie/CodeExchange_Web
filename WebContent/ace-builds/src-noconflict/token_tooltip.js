ace.define('kitchen-sink/token_tooltip', ['require', 'exports', 'module' , 'ace/lib/dom', 'ace/lib/event', 'ace/range'], function(require, exports, module) {
    ...
    (function(){
        ...
        this.update = function() {
            ...
            //so I need to see if they are hovering over a marker then if so display the
            //type of marker
...
//surgery here....
            ...
            var tokenText = "hello there dude!";
...
//
        ...
        this.$init = function() {
            ...
            st.borderTopRightRadius = "25";
            st.borderTopLeftRadius = "25";

            st.padding = "1px";
            st.zIndex = 1000;
            st.fontFamily = "monospace";
            st.whiteSpace = "pre-line";
            st.borderTop = "1px solid gray";
            return tooltipNode;
        };
